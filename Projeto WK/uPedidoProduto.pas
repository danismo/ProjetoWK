...
function TPedidoProduto.CarregaProdutos(var pProdutos: array of TPedidoProduto): boolean;
var
  i: integer;
begin
  result := false;
    ...
    with DM.qSqlQuery do begin
      ...
      if not(IsEmpty) then begin
        ...
        for i := 0 to RecordCount-1 do begin
          if Assigned(pProdutos[i]) then FreeAndNil(pProdutos[i]);
          pProdutos[i] := TPedidoProduto.Create;
